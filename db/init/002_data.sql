...
-- reward
('reward','positive','나를 위한 소비가 좋은 회복이 되었어요\n이런 소비는 줄이기보다 기준을 기억해두면 좋아요\n',NOW(),NOW()),
('reward','neutral','나를 위한 소비였지만 만족감이 크진 않았어요\n정말 필요한 보상이었는지 생각해보세요\n',NOW(),NOW()),
('reward','negative','보상 소비는 자연스럽지만 아쉬움이 남았다면\n예산을 정해두는 것이 좋아요\n',NOW(),NOW()),

-- impulse
('impulse','positive','즉흥적인 소비였지만 만족감이 남았어요\n다만 반복되지 않도록 관리가 필요해요\n',NOW(),NOW()),
('impulse','neutral','순간적으로 선택한 소비였어요\n다음에는 잠깐 멈춰보는 것도 좋아요\n',NOW(),NOW()),
('impulse','negative','충동 소비는 이후 아쉬움이 더 크게 남을 수 있어요\n하루 뒤 다시 보는 방법을 추천해요\n',NOW(),NOW()),

-- social
('social','positive','관계 속 소비가 만족스럽게 남았어요\n감당 가능한 범위에서 유지해보세요\n',NOW(),NOW()),
('social','neutral','자연스럽게 발생한 소비였어요\n다음에는 금액을 미리 정해보세요\n',NOW(),NOW()),
('social','negative','분위기 때문에 지출이 커졌을 수 있어요\n결제 전 한 번 더 확인해보세요\n',NOW(),NOW()),

-- need
('need','positive','필요한 소비를 잘 선택했어요\n생활을 위한 좋은 소비예요\n',NOW(),NOW()),
('need','neutral','필요한 소비였지만 만족감이 크지 않았어요\n대안이 있는지 확인해보세요\n',NOW(),NOW()),
('need','negative','필요했지만 아쉬움이 남았어요\n어떤 점이 문제였는지 돌아보세요\n',NOW(),NOW()),

-- etc
('etc','positive','오늘 소비가 전반적으로 괜찮았어요\n좋은 기준을 기억해보세요\n',NOW(),NOW()),
('etc','neutral','특별히 좋지도 나쁘지도 않은 소비였어요\n기록만 해도 충분해요\n',NOW(),NOW()),
('etc','negative','아쉬움이 남은 소비였어요\n상황을 돌아보면 다음 선택이 좋아져요\n',NOW(),NOW());
-- =========================================================
